...
export interface ApiAnimalAnimal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    animal_id: Schema.Attribute.UID<'nome'>;
    caracteristicas_do_animal: Schema.Attribute.JSON;
    caracteristicas_gerais: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_de_acolhimento: Schema.Attribute.Date;
    data_de_entrada: Schema.Attribute.Date;
...
export interface ApiVoluntarioVoluntario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aceita_cachorro: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    aceita_gato: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
